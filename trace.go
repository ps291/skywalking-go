...
import (
	...
	"artifacts-observability.sixthsense.rakuten.com/sixthsense/sixthsenseGoAgent/internal/idgen"
...
// Tracer is sixthsenseGoAgent tracer implementation.
type Tracer struct {
	service  string
	instance string
	reporter Reporter
...
// NewTracer return a new sixthsenseGoAgent Tracer
