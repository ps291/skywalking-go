...
[![Build](https://artifacts-observability.sixthsense.rakuten.com/sixthsense/sixthsenseGoAgent/workflows/Build/badge.svg?branch=master)](https://artifacts-observability.sixthsense.rakuten.com/sixthsense/sixthsenseGoAgent/actions?query=branch%3Amaster+event%3Apush+workflow%3ABuild)
[![Coverage](https://codecov.io/gh/SkyAPM/go2sky/branch/master/graph/badge.svg)](https://codecov.io/gh/SkyAPM/go2sky)
[![GoDoc](https://godoc.org/artifacts-observability.sixthsense.rakuten.com/sixthsense/sixthsenseGoAgent?status.svg)](https://godoc.org/artifacts-observability.sixthsense.rakuten.com/sixthsense/sixthsenseGoAgent)
...
# Installation
```
$ go get -u artifacts-observability.sixthsense.rakuten.com/sixthsense/sixthsenseGoAgent
```
...
import go2skylog "artifacts-observability.sixthsense.rakuten.com/sixthsense/sixthsenseGoAgent/log"
...
Go to go2sky-plugins repo to see all the plugins, [click here](https://artifacts-observability.sixthsense.rakuten.com/sixthsense/sixthsenseGoAgent-plugins).
