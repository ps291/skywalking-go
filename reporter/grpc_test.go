...
import (
	...
	mock "artifacts-observability.sixthsense.rakuten.com/sixthsense/sixthsenseGoAgent/reporter/grpc/management/mock_management"
...
func Test_e2e(t *testing.T) {
	...
	tracer, err := sixthsenseGoAgent.NewTracer(mockService, sixthsenseGoAgent.WithReporter(reporter), sixthsenseGoAgent.WithInstance(mockServiceInstance))
	if err != nil {
		t.Error(err)
	}
...
func createGRPCReporter() *gRPCReporter {
	reporter := &gRPCReporter{
		logger: log.New(os.Stderr, "sixthsenseGoAgent", log.LstdFlags),
	}
	return reporter
}
